...
const Portfolio = () => {
  ...
  const skills = {
    ...
    Databases: ['PostgreSQL', 'Firebase', 'MongoDB', 'Vector Databases'],
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6 text-lg text-gray-300 leading-relaxed">
            ...
            <p>
              ...
              integrating cutting-edge AI models like CLIP and GPT-4. I've led
              cross-functional teams, deployed production systems, and focused
              on what matters— building things people actually use.
            </p>
      ...
      >
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex justify-center space-x-6">
            ...
            <a
              href="https://linkedin.com/in/husnain"
              target="_blank"
              rel="noopener noreferrer"
              className="p-4 glass-effect rounded-xl hover:bg-white/5 transition-all hover:scale-110"
            >
      ...
      <footer className="py-8 px-6 border-t border-white/5">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-gray-600 text-xs mt-2">
            Designed & Developed by Husnain Khaliq
          </p>
        </div>
      </footer>
    </div>
